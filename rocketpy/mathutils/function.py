    ...
    def __init__(
        ...
        **kwargs,
        ...
        extrapolation : string, optional
            ...
            N-D 'linear', which falls back to an RBF extrapolator because
            SciPy's LinearNDInterpolator only interpolates inside the convex
            hull. For regular-grid functions, 'natural' uses SciPy's regular
            grid extrapolation behavior. 'constant' returns the value of the
            function at the nearest edge of the domain, and 'zero' returns zero
            for all points outside the source range.
